...
**3. The Open Phytolith Community:**
  *  This includes anyone that has made a named [contribution](https://open-phytoliths.github.io/FAIRer_phytoliths/CONTRIBUTING.html#recording-contributions) to our project. These contributions are recorded using the all contributions bot and can be seen in both our GitHub repository [README file](https://github.com/open-phytoliths/FAIRer_phytoliths#contributors-) and [home page](https://open-phytoliths.github.io/FAIRer_phytoliths/#contributors-).
