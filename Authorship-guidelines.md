...
**3. The Open Phytolith Community:**
  ...
  *  The barrier for entry onto the [list of contributors](https://open-phytoliths.github.io/FAIR-phytoliths/#contributors-) is very low. If you have contributed in any of the ways listed in the [emoji key](https://allcontributors.org/docs/en/emoji-key) then please [ask one of the core team](https://open-phytoliths.github.io/FAIR-phytoliths/CONTRIBUTING.html#acknowledgement-of-contributors) to use the all contributors bot to add you to the list.
